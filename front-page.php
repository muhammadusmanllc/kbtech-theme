...
<!-- ==============================================
     OUR CLIENTS SECTION (TEXT VERSION)
     ============================================== -->
<section class="our-clients-section section-padding">
    <div class="container">
        ...
        <!-- Clients Text Grid -->
        <div class="clients-flex-wrapper">
            
            <!-- 1. Mighty Dispatch -->
            <a href="https://mightydispatch.com" target="_blank" class="client-text-link">
                MIGHTY DISPATCH
            </a>

            <!-- 2. New Asia Sports -->
            <a href="#" target="_blank" class="client-text-link">
                NEW ASIA SPORTS
            </a>
